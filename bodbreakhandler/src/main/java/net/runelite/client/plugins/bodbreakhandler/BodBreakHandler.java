...
public class BodBreakHandler
{
	...
	@Inject
	BodBreakHandler(ConfigManager configManager)
	{
	...
	{
		int from = Integer.parseInt(configManager.getConfiguration(BodBreakHandlerPlugin.CONFIG_GROUP, sanitizedName(plugin) + "-breakfrom")) * 60;
		int to = Integer.parseInt(configManager.getConfiguration(BodBreakHandlerPlugin.CONFIG_GROUP, sanitizedName(plugin) + "-breakto")) * 60;
