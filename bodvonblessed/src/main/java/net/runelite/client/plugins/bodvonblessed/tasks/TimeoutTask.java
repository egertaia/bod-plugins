...
import net.runelite.client.plugins.bodvonblessed.ConditionTimeout;
...
import net.runelite.client.plugins.bodvonblessed.TimeoutWhile;
...
public class TimeoutTask extends Task
{
    ...
    {
        ConditionTimeout conditionTimeout = BodVonBlessedPlugin.conditionTimeout;
        ...
        return BodVonBlessedPlugin.timeout > 0;
    }
    ...
    {
        BodVonBlessedPlugin.conditionTimeout = null;
        BodVonBlessedPlugin.timeoutFinished = true;
    }
    ...
    public void onGameTick(GameTick event)
    {
        ...
        if (BodVonBlessedPlugin.timeout > 0)
        {
            BodVonBlessedPlugin.timeout--;
            if (BodVonBlessedPlugin.timeout == 0)
            {
                BodVonBlessedPlugin.timeoutFinished = true;
            }
