...
@Slf4j
@Singleton
class BodVonBlessedOverlay extends OverlayPanel
{
    private final Client client;
    private final BodVonBlessedPlugin plugin;
    ...
    private BodVonBlessedOverlay(final Client client, final BodVonBlessedPlugin plugin, final BodVonBlessedConfig config)
    {
        ...
        this.plugin = plugin;
        this.config = config;
        getMenuEntries().add(new OverlayMenuEntry(RUNELITE_OVERLAY_CONFIG, OPTION_CONFIGURE, "BodVonBlessed overlay"));
    }
