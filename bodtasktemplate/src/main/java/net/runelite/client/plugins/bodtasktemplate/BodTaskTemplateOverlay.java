...
@Slf4j
@Singleton
class BodTaskTemplateOverlay extends OverlayPanel
{
	private final Client client;
	private final BodTaskTemplatePlugin plugin;
	private final BodTaskTemplateConfig config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private BodTaskTemplateOverlay(final Client client, final BodTaskTemplatePlugin plugin, final BodTaskTemplateConfig config)
	{
		super(plugin);
	...
	public Dimension render(Graphics2D graphics)
	{
		...
		tableDelayComponent.addRow("Sleep delay:", BodTaskTemplatePlugin.sleepLength + "ms");
