 ...
 */
package net.runelite.client.plugins.bodutils;
...
@PluginDescriptor(
	name = "Bod Utils",
	description = "Dadbod plugin utilities",
	hidden = false
)
@Slf4j
@SuppressWarnings("unused")
@Singleton
public class BodUtils extends Plugin
{
	@Inject
	...
	@Provides
	BodUtilsConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(BodUtilsConfig.class);
	}
